...
if ( ! class_exists( 'categoryProductTabWidget_Admin' ) ) { 
	class categoryProductTabWidget_Admin extends categoryProductTabLib {    
		...
		*/
		function form( $instance ) {  
			...
			require( $this->getcategoryProductTabTemplate( 'admin_widget_settings.php' ) );
